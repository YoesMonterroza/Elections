...
using Elections.UnitTests.Shared;
...
namespace Elections.UnitTests.Repositories
{
    ...
    public class GenericRepositoryTests
    {
        ...
        private GenericRepository<ElectoralPosition> _repository = null!;
        [TestInitialize]
        public void Initialize()
        {
            ...
            _repository = new GenericRepository<ElectoralPosition>(_context);
        }
        [TestCleanup]
        public void Cleanup()
        {
        ...
        {
            // Arrange
            var testEntity = new ElectoralPosition { Name = "Test" };
            // Act
        ...
        public async Task AddAsync_GeneralExceptionThrown_ReturnsError()
        {
            ...
            var repository = new GenericRepository<ElectoralPosition>(exceptionalContext);
            var testEntity = new ElectoralPosition { Name = "Test" };
            // Act
        ...
        {
            // Arrange
            var category = new ElectoralPosition { Id = 1, Name = "Test" };
            await _context.Set<ElectoralPosition>().AddAsync(category);
        ...
        public async Task DeleteAsync_ShouldDeleteEntity()
        {
            // Arrange
            var testEntity = new ElectoralPosition { Name = "Test" };
            await _context.Set<ElectoralPosition>().AddAsync(testEntity);
            await _context.SaveChangesAsync();
            // Act
        ...
        {
            // Arrange
            await _context.Set<ElectoralPosition>().AddRangeAsync(new List<ElectoralPosition>
            {
            new ElectoralPosition { Name = "Test1" },
            new ElectoralPosition { Name = "Test2" },
            new ElectoralPosition { Name = "Test3" },
            });
            await _context.SaveChangesAsync();
            // Act
        ...
        public async Task UpdateAsync_GeneralExceptionThrown_ReturnsError()
        {
            ...
            var exceptionalContext = new ExceptionalDataContext(_options);
            var testEntity = new ElectoralPosition { Name = "Test" };
            await exceptionalContext.Set<ElectoralPosition>().AddAsync(testEntity);
